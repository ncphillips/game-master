...
PlayerCharacter = (function() {
    ...
    PlayerCharacter.prototype.getId = function(){ return this.__data__._id; };
    PlayerCharacter.prototype.getName = function() { return this.__data__.name; };
    PlayerCharacter.prototype.getSize = function() { return this.__data__.size; };
    PlayerCharacter.prototype.getAc = function(){ return this.__data__.ac; };
    PlayerCharacter.prototype.getHp = function(){ return this.__data__.hp; };
    PlayerCharacter.prototype.getAbilities = function(){ return this.__data__.abilities; };
    PlayerCharacter.prototype.getSavingThrows= function(){ return this.__data__.savingThrows; };
    PlayerCharacter.prototype.getActions= function(){ return this.__data__.actions; };
    PlayerCharacter.prototype.getLanguages = function(){ return this.__data__.languages; };
    PlayerCharacter.prototype.getDamageAdjustments = function(){ return this.__data__.damageAdjustments; };
    PlayerCharacter.prototype.getSenses= function(){ return this.__data__.senses; };
