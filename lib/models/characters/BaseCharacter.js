...
BaseCharacter = (function() {
    ...
    BaseCharacter.prototype.hasStatusEffect = function(target){
        // Todo: Reimplement
        console.log("Todo: Re-implement method");
        return false;
    };
    ...
    BaseCharacter.prototype.rollInitiative = function(){
        var dexBonus = Math.floor((this.__data__.abilities.dex - 10) / 2);
        this.__data__.initiative = rollD20(dexBonus)
    };
